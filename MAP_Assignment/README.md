# MAP Implementation
To implement your map algorithm you should write the majority of your code in `map.py` and then complete the functions in `factor.py`. Additionally, you may choose to add additional files for a logger and heuristics.


# Testing your Implementation
After implementing your MAP algorithm, you can verify it is working correctly by doing the following:
